...
Scope: maintained documentation and operator runbooks.
...
Prefer one canonical document for each contract. Link to it instead of creating near-duplicate guides.

`index.md` files are navigation maps and should stay concise. Longer explanations, decisions and runbooks belong in the appropriate canonical document.
