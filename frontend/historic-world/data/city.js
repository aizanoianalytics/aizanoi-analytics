...
export const BUILDINGS = Object.freeze([
  B('temple', 'Temple of Zeus', 'temple', -160, 20, 55, 35, 18, 'sanctuary', 'temple', 'Octastyle pseudodipteral sanctuary; the blocky asset preserves the temple identity while terrain elevation is intentionally removed.', { asset: 'temple-of-zeus', framing: { distance: 120, roadDistance: 92, preferredDirections: [[1,0]] } }),
