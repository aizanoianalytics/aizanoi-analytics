...
7. Preserve deep-link `?jump=...`, `__AIZANOI_DEBUG__`, mobile controls, AizanoiOS navigation and the rendered period UI contract.
...
- Browser smoke: enter, WASD, mouse look, touch joystick, inspect, atlas, sources, available era controls and all landmark teleports.
...
- Verify no console errors and exactly one `← AizanoiOS` control.
