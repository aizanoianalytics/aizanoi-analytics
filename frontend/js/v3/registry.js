...
export const APPS = Object.freeze([
  ...
  { id:'archive', label:'Field Archive', short:'Archive', group:'workbench', icon:'/assets/icons/field-archive.svg', module:'/js/v3/apps/archive.js', description:'Local records, sources, datasets and captures', keywords:['archive','files','records','sources','local'], launcher:false, searchable:false },
  { id:'notes', label:'Field Notes', short:'Notes', group:'workbench', icon:'/assets/icons/notepad.svg', module:'/js/v3/apps/research.js', description:'Observations, hypotheses and source reviews', keywords:['notes','write','observation','hypothesis'], launcher:false, searchable:false },
  { id:'data-lab', label:'Data Lab', short:'Data', group:'workbench', icon:'/assets/icons/data-lab.svg', module:'/js/v3/apps/research.js', description:'Inspect local CSV and JSON datasets', keywords:['data','csv','json','table','dataset'], launcher:false, searchable:false },
  { id:'source-reader', label:'Source Reader', short:'Sources', group:'workbench', icon:'/assets/icons/source-reader.svg', module:'/js/v3/apps/research.js', description:'Read local PDF, Markdown and text sources', keywords:['source','reader','pdf','markdown','citation'], launcher:false, searchable:false },
  { id:'artifact-viewer', label:'Artifact Viewer', short:'Viewer', group:'workbench', icon:'/assets/icons/artifact-viewer.svg', module:'/js/v3/apps/research.js', description:'Inspect visual records with provenance', keywords:['artifact','image','viewer','photo','provenance'], launcher:false, searchable:false },
  { id:'projects', label:'Projects', short:'Projects', group:'workbench', icon:'/assets/icons/projects.svg', module:'/js/v3/apps/projects.js', description:'Internal project and research workspace', keywords:['projects','historical worlds','research'], launcher:false, searchable:false },
  { id:'terminal', label:'Field Terminal', short:'Terminal', group:'workbench', icon:'/assets/icons/terminal.svg', module:'/js/v3/apps/terminal.js', description:'Browser-only commands for the local workspace', keywords:['terminal','command','worlds','evidence','session'], launcher:false, searchable:false },
  { id:'monitor', label:'Workspace Monitor', short:'Monitor', group:'workbench', icon:'/assets/icons/workspace-monitor.svg', module:'/js/v3/apps/monitor.js', description:'Real local storage, session and PWA status', keywords:['monitor','storage','offline','pwa','session','viewport'], launcher:false, searchable:false }
]);
...
export function searchableEntries() {
  return [
    ...
    ...APPS.filter((app)=>app.searchable!==false).map((app) => ({ type:'app', id:app.id, label:app.label, description:app.description, keywords:[app.label,app.short,app.description,...app.keywords] }))
  ];
}
