...
export const APPS = Object.freeze([
  ...
  { id:'games', label:'Aizanoi Arcade', short:'Arcade', group:'explore', icon:'/assets/icons/aizanoi-arcade.svg', module:'/js/v3/apps/games.js', description:'Playable local browser games', keywords:['games','arcade','snake','mines','brick','play'] }
]);
