...
const APP_DEFINITIONS = Object.freeze([
  ...
  { id:'dungeon', label:'Aizanoi Dungeon', short:'Dungeon', group:'explore', icon:'/assets/icons/aizanoi-dungeon.svg', moduleId:'dungeon', description:'Aizo\'s Awakening — a 10-chapter retro dungeon-crawler RPG in the Zeus Temple and Penkalas catacombs', keywords:['dungeon','rpg','aizo','phaser','zeus','temple','penkalas','action','adventure'] },
