...
const APP_DEFINITIONS = Object.freeze([
  ...
  { id:'markets', label:'Aizanoi Markets', short:'Markets', group:'studio', icon:'/assets/icons/aizanoi-markets.svg', moduleId:'markets', description:'Live US equities and crypto market intelligence across 5,600+ instruments with momentum, volatility, relative strength and data-quality signals', keywords:['markets','stocks','crypto','equities','ticker','trading','finance','yahoo','dashboard','us','btc','eth'] },
