...
const APP_DEFINITIONS = Object.freeze([
  ...
  { id:'fly-world', label:'Fly World', short:'Fly', group:'explore', icon:'/assets/icons/fly-world.svg', moduleId:'fly-world', fullscreen:true, description:'Experimental ghost-observer walkthrough of the rustic Fly House interior — the future home of the fly simulation', keywords:['fly','fly world','fly house','labs','experiment','prototype','webgl','ghost observer'] },
