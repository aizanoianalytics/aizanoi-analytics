...
export const APPS = Object.freeze([
  ...
  { id:'notepad', label:'Notepad', short:'Notepad', group:'studio', icon:'/assets/icons/aizanoi-journal.svg', module:'/js/v3/apps/notepad.js', description:'Plain-text editor that saves documents into the Workspace', keywords:['notepad','text','editor','notes','txt'] },
