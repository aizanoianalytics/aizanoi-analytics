...
const APP_DEFINITIONS = Object.freeze([
  ...
  { id:'worlds', label:'Historical Worlds', short:'Worlds', group:'explore', icon:'/assets/icons/aizanoi-worlds.svg', module:'/js/v3/apps/worlds.js', description:'Evidence-aware walkable Aizanoi, Rome and Athens', keywords:['worlds','aizanoi','rome','athens','history','archaeology'] },
  { id:'forge', label:'Aizanoi Forge', short:'Forge', group:'studio', icon:'/assets/icons/aizanoi-forge.svg', module:'/js/v3/apps/brand-hubs.js', description:'Source, builds and open projects with GitHub as the canonical source of truth', keywords:['forge','source','github','code','open source','builds','projects'] },
  { id:'journal', label:'Aizanoi Journal', short:'Journal', group:'media', icon:'/assets/icons/aizanoi-journal.svg', module:'/js/v3/apps/brand-hubs.js', description:'Analysis, essays, commentary and long-form research', keywords:['journal','analysis','essay','commentary','research','opinion'] },
  ...
  { id:'camera', label:'Camera', short:'Camera', group:'media', icon:'/assets/icons/aizanoi-news.svg', moduleId:'camera', description:'Local camera capture — photos stay on this device', keywords:['camera','photo','webcam','picture','capture'] },
  { id:'winamp', label:'Winamp', short:'Winamp', group:'media', icon:'/assets/icons/aizanoi-tv.svg', moduleId:'winamp', description:'Playlist player for local and Workspace audio', keywords:['winamp','music','audio','player','playlist','mp3'] },
