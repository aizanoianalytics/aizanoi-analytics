...
const APP_DEFINITIONS = Object.freeze([
  ...
  { id:'fly-world', label:'Fly World', short:'Fly', group:'explore', icon:'/assets/icons/fly-world.svg', moduleId:'fly-world', fullscreen:true, description:'Experimental Fly House simulation with read-only authoritative telemetry, deterministic fly behaviour and a connectome-derived LC4 escape-circuit research surface', keywords:['fly','fly world','fly house','labs','experiment','webgl','observer','telemetry'] },
