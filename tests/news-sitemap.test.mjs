...
const fixture = {
  ...
  summary:'This deliberately complete fixture gives the News build enough structured content to validate edition and category discovery URLs without relying on production content.',
  category:'ai',
...
test('News build publishes edition and category discovery into sitemap', async () => {
...
test('failed staged News build preserves the previously published sitemap', async () => {
  const dir = await project();
