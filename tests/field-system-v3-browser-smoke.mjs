...
const publicAppIds=['news','videos','analytics','markets','worlds','forge','journal','labs','games','workspace','notepad','web-editor','calculator','browser','camera','winamp','recycle-bin'];
const desktopAppIds=['news','videos','analytics','markets','worlds','forge','browser','notepad','web-editor','calculator','camera','winamp','games','recycle-bin','workspace'];
