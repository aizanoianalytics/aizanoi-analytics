...
for(const [id,path,hero] of worlds){
  ...
  // Settle past the 0.8s cinematic fade before judging pixels — mid-fade frames read black.
  await page.waitForFunction(()=>{const ov=document.querySelector('.cinematic-title');return !ov||getComputedStyle(ov).display==='none';},null,{timeout:15000});
