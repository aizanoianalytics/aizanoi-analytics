...
test('Camera photo flow requests video only and cannot request microphone access', () => {
  ...
  assert.doesNotMatch(privateApp, /getUserMedia\(\{video:false,audio:true\}\)/);
  assert.doesNotMatch(privateApp, /requestOptionalMicrophone|microphone permission|microphoneActive/);
