...
test('desktop keeps the five core apps and promotes a curated utility set', () => {
  assert.match(brandPlatform, /const DESKTOP=Object\.freeze\(\[\.\.\.PINNED,'markets','browser','notepad','web-editor','calculator','camera','winamp','games','dungeon','fly-world','recycle-bin','workspace'\]\)/);
