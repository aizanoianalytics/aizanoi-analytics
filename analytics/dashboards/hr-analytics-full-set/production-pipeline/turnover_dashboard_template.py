  ...
  <div class="shell">
    ...
    <section class="filter-shell" aria-label="Global filtreler">
      <div class="filter-grid">
        <div class="field"><label>Kapsam</label><select class="select" id="scope-filter" aria-label="Kapsam"></select></div>
        <div class="field"><label>Turnover Türü</label><select class="select" id="type-filter" aria-label="Turnover Türü">
        ...
        <div class="field"><label>Başlangıç</label><select class="select" id="start-filter" aria-label="Başlangıç Dönemi"></select></div>
        <div class="field"><label>Bitiş</label><select class="select" id="end-filter" aria-label="Bitiş Dönemi"></select></div>
        <div class="field"><label>Bölge</label><select class="select" id="region-filter" aria-label="Bölge"></select></div>
        <div class="field"><label>Mağaza</label><select class="select" id="store-filter" aria-label="Mağaza"></select></div>
        <div class="field"><label>Departman</label><select class="select" id="department-filter" aria-label="Departman"></select></div>
        <div class="field"><label>Şehir</label><select class="select" id="city-filter" aria-label="Şehir"></select></div>
        <div class="field"><label>Cinsiyet</label><select class="select" id="gender-filter" aria-label="Cinsiyet"></select></div>
        <div class="field"><label>Sözleşme Türü</label><select class="select" id="contract-filter" aria-label="Sözleşme Türü"></select></div>
        <div class="field"><label>Title</label><select class="select" id="title-filter" aria-label="Title"></select></div>
      ...
      <section class="page active" data-page="overview">
        ...
        <article class="card" style="margin-top:14px">
          <div class="card-head">
            ...
            <div class="card-actions"><select class="select" id="scope-trend-mode" aria-label="Trend Hesaplama Modu" style="min-width:190px"><option value="monthly">Aylık Turnover</option><option value="ytd">Yıl İçi Kümülatif Turnover</option></select></div>
          </div>
